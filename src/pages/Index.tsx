          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <p className="font-body font-light text-muted-foreground leading-relaxed mb-6 text-base">
                AVG-Consult основана в 2024 году одним из лучших практикующих юристов по трудовому праву в России, с опытом в международной юридической фирме. Мы специализируемся на сложных делах, где на кону — судьба бизнеса.
              </p>
