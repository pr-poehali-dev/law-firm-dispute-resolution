...
const SERVICES = [
  ...
  {
    icon: "Gavel",
    title: "Споры в судах общей юрисдикции",
    desc: "Представляем интересы физических лиц и бизнеса в районных, городских и апелляционных судах. Ведём дела любой сложности — от взыскания долгов до защиты деловой репутации.",
    tag: "Судебный",
  },
  {
    icon: "BarChart2",
    title: "Антимонопольное право",
    desc: "Сопровождение в ФАС, оспаривание предписаний и штрафов, консультирование по вопросам картельных соглашений, злоупотребления доминирующим положением и недобросовестной конкуренции.",
    tag: "Регуляторный",
  },
  {
    icon: "Briefcase",
    title: "Трудовое право",
    desc: "Комплексная защита работодателей и работников: трудовые споры, незаконные увольнения, дискриминация, разработка кадровых документов и локальных актов, сопровождение проверок ГИТ.",
    tag: "Трудовой",
  },
];
...
const CASES = [
  ...
  },
  {
    ...
    title: "Защита интересов миноритарного участника в рамках выплаты действительности стоимости его доли и отклонении требований о взыскании убытков от его деятельности, как генерального директора Общества.",
    result: "Победа",
    desc: "",
    duration: "",
  },
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            <div className="relative">
              ...
              <div className="relative border border-border overflow-hidden">
                <img src={TEAM_IMAGE} alt={`Команда ${FIRM_NAME}`} className="w-full object-contain bg-[#0f1117]" />
                ...
                <div className="absolute bottom-6 left-6 right-6">
                  <div className="border border-electric/30 bg-background/80 backdrop-blur-sm px-5 py-4">
                    ...
                    <div className="font-body text-white text-sm">Рекомендованные юристы по Трудовому праву по версии Право.ру</div>
                  </div>
                </div>
              </div>
            </div>
